 ...
 */
#define ARCHLIB "/usr/lib/perl5/5.8.8/msys"		/**/
#define ARCHLIB_EXP "/usr/lib/perl5/5.8.8/msys"		/**/
...
#define PRIVLIB_EXP "/usr/lib/perl5/5.8.8"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/lib/perl5/site_perl/5.8.8/msys"		/**/
#define SITEARCH_EXP "/usr/lib/perl5/site_perl/5.8.8/msys"		/**/
...
#define SITELIB_EXP "/usr/lib/perl5/site_perl/5.8.8"		/**/
