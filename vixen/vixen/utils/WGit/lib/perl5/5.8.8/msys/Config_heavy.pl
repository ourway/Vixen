...
ar='ar'
archlib='/usr/lib/perl5/5.8.8/msys'
...
cccdlflags=' '
ccdlflags=' -s'
ccflags='-DPERL_USE_SAFE_PUTENV -fnative-struct -fno-strict-aliasing -pipe'
...
cpp='cpp'
cpp_stuff='42'
cppccsymbols='__GNUC__=2 __MSYS__=1 i386=1 unix=1'
cppflags='-DPERL_USE_SAFE_PUTENV -fnative-struct -fno-strict-aliasing -pipe'
cpplast='-'
cppminus='-'
cpprun='gcc -E'
cppstdin='gcc -E'
cppsymbols='__GNUC_MINOR__=95 _LONG_DOUBLE=long\ double __STDC__=1 __i386=1 __i386__=1 i586=1 __i586=1 __i586__=1 _unix=1 __unix=1 __unix__=1'
crypt_r_proto='0'
cryptlib=''
csh='csh'
ctermid_r_proto='0'
...
incpath=''
inews=''
installarchlib='/usr/lib/perl5/5.8.8/msys'
installbin='/usr/bin'
installhtml1dir=''
installhtml3dir=''
installman1dir=''
...
installsitearch='/usr/lib/perl5/site_perl/5.8.8/msys'
...
shmattype=''
shortsize='2'
shrpenv='env LD_RUN_PATH=/usr/lib/perl5/5.8.8/msys/CORE'
shsharp='true'
sig_count='32'
...
sig_size='34'
signal_t='void'
sitearch='/usr/lib/perl5/site_perl/5.8.8/msys'
...
ccflags_nolargefiles='-DPERL_USE_SAFE_PUTENV -fnative-struct -fno-strict-aliasing -pipe'
